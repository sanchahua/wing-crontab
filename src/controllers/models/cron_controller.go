...
func (db *CronController) Add(cronSet, command string, remark string, stop bool) (*cron.CronEntity, error) {
	return db.cr.Add(cronSet, command, remark, stop)
}

func (db *CronController) Update(id int64, cronSet, command string, remark string, stop bool) (*cron.CronEntity,error) {
	return db.cr.Update(id, cronSet, command, remark, stop)
}

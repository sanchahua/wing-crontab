...
func MakeMetaData(endpoint, metric, tags string, val interface{}, counterType string, step_and_ts ...int64) *JsonMetaData {
	md := JsonMetaData{
		Endpoint:    endpoint,
		Metric:      metric,
		Tags:        tags,
...
func MakeGaugeValue(endpoint, metric, tags string, val interface{}, step_and_ts ...int64) *JsonMetaData {
	return MakeMetaData(endpoint, metric, tags, val, "GAUGE", step_and_ts...)
}

func MakeCounterValue(endpoint, metric, tags string, val interface{}, step_and_ts ...int64) *JsonMetaData {
